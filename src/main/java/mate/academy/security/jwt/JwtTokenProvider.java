...
public class JwtTokenProvider {
    ...
    private static final String BEARER_START_STRING = "Bearer ";
    ...
    public String resolveToken(HttpServletRequest request) {
        ...
        if (bearerToken != null && bearerToken.startsWith(BEARER_START_STRING)) {
            return bearerToken.substring(BEARER_START_STRING.length());
        }
        return null;
    }
